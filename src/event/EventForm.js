...
class EventForm extends Component {
  ...
  validateStartTime() {
    if (moment(this.state.start_time,'YYYY-MM-DD HH:mm:ss').isValid() && moment(this.state.start_time).valueOf() <= moment(this.state.end_time).valueOf() ) {
      return 'success';
    } else {
      return 'error';
    }
  ...
  validateEndTime() {
    if (moment(this.state.end_time, 'YYYY-MM-DD HH:mm:ss').isValid() && moment(this.state.end_time).valueOf() >= moment(this.state.start_time).valueOf()) {
      return 'success';
    } else {
      return 'error';
    }
